...
const courses = [
  {
    ...
    description: "Comprehensive Python programming course covering fundamentals to advanced concepts, including web development, data science, and automation.",
    completed: true,
    skills: ["Python", "Flask", "SQLite", "API Development", "Web Scraping"]
  },
  {
    title: "MERN Stack Development",
    platform: "Connect Shiksha",
  ...
  },
  {
    ...
    completed: true,
    skills: ["JavaScript", "Python", "Web Development", "Problem Solving"]
  }
];
